package info.covid.uicomponents.customview.rings;
...
public class Rings extends View {
    ...
    public String innerFirstText;
    public String innerSecondText;
    public String innerThirdText;
    ...
    public Rings(Context context, AttributeSet attrs, int defStyle) {
        ...
        defaultTextSize = Utils.sp2px(getResources(), 10);
        defaultTextMarginLeft = Utils.sp2px(getResources(), 10);
        defaultInnerStrokeWidth = Utils.sp2px(getResources(), 6);
        defaultInnerStrokeUnfinishedWidth = Utils.sp2px(getResources(), 8);
        defaultOuterStrokeWidth = Utils.sp2px(getResources(), 6);
        defaultOuterStrokeUnfinishedWidth = Utils.sp2px(getResources(), 8);
