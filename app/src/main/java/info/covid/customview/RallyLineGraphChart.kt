...
class RallyLineGraphChart : View {
  ...
  private fun init(set: AttributeSet?) {
    ...
    val borderColor =
      ta.getColor(R.styleable.RallyLineGraphChart_curveBorderColor, Color.parseColor("#FF66AFFF"))
    ...
    pathPaint.apply {
      ...
      color = fillColor
      shader = LinearGradient(0f, 0f, 0f, height.toFloat(), Color.BLACK, Color.WHITE, Shader.TileMode.CLAMP)
    }
